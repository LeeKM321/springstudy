  ...
  <body>
    <div class="wrap">
      <section class="score-main">
        <h1>${stu.stuName}님 성적 정보 수정하기~</h1>
        <form action="/score/modify" method="post">
          <input type="hidden" name="stuNum" value="${stu.stuNum}" />
          <ul>
            <li># 국어: <input type="text" name="kor" value="${stu.kor}" /></li>
            <li># 영어: <input type="text" name="eng" value="${stu.eng}" /></li>
            <li>
              # 수학: <input type="text" name="math" value="${stu.math}" />
            </li>
          </ul>
          <div class="btn-group">
